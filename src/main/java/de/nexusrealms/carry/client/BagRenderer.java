...
public class BagRenderer implements TrinketRenderer {
    ...
    public BagRenderer(Supplier<TexturedModelData> overlayLayer, Supplier<TexturedModelData> baseLayer, Supplier<TexturedModelData> strapLayer, Identifier overlayTexture, Identifier baseTexture, Identifier strapTexture) {
